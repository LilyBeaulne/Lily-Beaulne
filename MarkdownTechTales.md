...
### Initial Prompt for Synopsis

Help me brainstorm a plot and characters for a short children’s story book that explores using AI in a safe manner. 
The goal of this book is to help kids responsibly use AI. 

*Iterative prompts were then given to flesh out the narrative and character*

### Initial Prompt for Concept Illustrations

Create an illustrated visual for Ava and Buddy’s characters 

*Iterative prompts were given to clarify the visuals of Buddy and Ava*

### Initial Prompt for Story Content

Create a brief comic that showcases one of the lessons Ava learns from Buddy.  

*Iterative prompts were given to figure out the focus of the story content, including dialogue and illustrations*
...
<sup> **Everything in this section is generated by Co-pilot, Spelling and Grammar are left as produced by Co-Pilot**
...
<sup> **Grammar is left as produced by Co-Pilot**
...
### Resources Used
[ Microsoft Copilot. (2025).](https://www.microsoft.com/en-us/microsoft-copilot/for-individuals?form=MY02P9)

<!-- here I added a 'works cited' type section to reference co-pilot as suggested by my peer reviewer. I fixed obvious grammar mistakes except for when it was text generated by copilot. I made a note for the reader awknowledging this as part of the revision furhter emphasizing when content was the output of Co-pilot. I also added a sectio after my process to show some prompts I used to give more insight
--> 
